...
!function (window) {
    ...
    Spinner.prototype.bindEvent = function () {
        var _this = this,
            options = _this.options,
            mousedownEvent = 'mousedown.spinner',
            mouseupEvent = 'mouseup.spinner';
        ...
        _this.$input.on('change.spinner', function () {
    ...
    function Plugin(option) {
        ...
        return this.each(function () {
            var $this = $(this),
                spinner = $this.data('billing.spinner');

            if (!spinner) {
                $this.data('billing.spinner', (spinner = new Spinner(this, option)));
            }
    ...
    $(window).on('load.spinner', function () {
        $('[data-spinner]').each(function () {
            var $this = $(this);
            $this.spinner(parseOptions($this.data('spinner')));
        });
    });
